...
main_output_label = f"revision_sklearn_random_forest_manual_{train_percent}train"
...
tables.append(("clr_DADA2", (os.path.join(output_dir, "tables", "filtered_90prcnt_clr_asv.csv"), ","), "white"))
tables.append(("raw_DADA2",(os.path.join(output_dir, "tables", "filtered_90prcnt_dada2.csv"),","),"white"))
...
tables.append(("lognorm__prev_filt_DADA2", (os.path.join(output_dir, "tables", "filtered_90prcnt_lognorm_dada2.csv"), ","), "y"))
tables.append(("Silva_filt_DADA2", (os.path.join(output_dir,"tables", "prev_filt90_Silva_DADA2", "prev_filt90_Silva_DADA2.csv"), ","), "white"))
...
tables.append(("prev_filt90_UPGMA_DADA2", (os.path.join(output_dir,"tables", "prev_filt90_UPGMA_DADA2", "prev_filt90_UPGMA_DADA2.csv"), ","), "white"))
tables = add_PhILR_dfs_to_table(tables, os.path.join(output_dir, "tables", "prev_filt90_UPGMA_DADA2"), "Filtered_UPGMA_DADA2", color = "#050598")
tables.append(("prev_filt90_IQtree", (os.path.join(output_dir,"tables", "Filtered_IQtree", "prev_filt90_IQtree.csv"), ","), "white"))
