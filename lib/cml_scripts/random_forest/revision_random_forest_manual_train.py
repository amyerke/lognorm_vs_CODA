...
tables.append(("propotions_prev_filt_DADA2", (os.path.join(output_dir, "tables", "filtered_90prcnt_propotions_asv.csv"), ","), "lime"))
tables.append(("Heilinger_prev_filt_DADA2", (os.path.join(output_dir, "tables", "filtered_90prcnt_heilinger_asv.csv"), ","), "lime"))
...
tables.append(("lognorm_prev_filt_DADA2", (os.path.join(output_dir, "tables", "filtered_90prcnt_lognorm_dada2.csv"), ","), "lime"))
