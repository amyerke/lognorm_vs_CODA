...
plot_pdf_fpath = os.path.join(output_dir, "seminar_summary_pval_acc_vs_acc.pdf")
plotdata_fpath = os.path.join(home_dir,"metastudies","output","seminar_summary_pvalue_plot.csv")
# --------------------------------------------------------------------------
